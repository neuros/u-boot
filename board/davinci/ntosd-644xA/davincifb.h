...
/* PINMUX0 register */
/* defined in asm/arch/hardware.h */
...
#define VENC_VIDCTL_VLCKP                  	(1 << 14)       //JG: Added this line
#define VENC_VIDCTL_VLCKE                 	(1 << 13)       //JG: Added this line
#define VENC_VIDCTL_VLCKZ                  	(1 << 12)       //JG: Added this line
#define VENC_VDPRO_CBTYPE                	(1 << 9)        //JG: Added this line
#define VENC_VDPRO_CBMD                    	(1 << 8)        //JG: Added this line
#define VENC_SYNCCTL_SYSW                  	(1 << 5)	//JG: Added this line
#define VENC_SYNCCTL_SYEV                  	(1 << 1)	//JG: Added this line
#define VENC_SYNCCTL_SYEH                  	(1 << 0)	//JG: Added this line
#define VENC_DCKCTL_DCKEC                  	(1 << 11)	//JG: Added this line
...
// Enumerated List of supported Video DACs on DaVinci digital backend
// This is where we can add other video DACs
#define DAC_AUTO_DETECT 0
#define DAC_THS8200 1
#define DAC_MAX 1
...
#define FBIO_SET_VIDEODAC	_IOW('F', 0x26, u_int32_t)
...
#define FBIO_SETLCDTIMEPARAMS	_IOW('F', 0x27, struct lcd_timing_params)

/*
** Declare some functiona available in ths8200.c file
*/
